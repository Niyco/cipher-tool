if __name__ == '__main__':
    ...
    def create_widgets():
        ...
        stages_canvas = ctk.CTkCanvas(root, bg=bg_color, highlightthickness=0)
    ...
    x = multiprocessing.Process(target=darkdetect.listener, args=(queue.put,)).start()
